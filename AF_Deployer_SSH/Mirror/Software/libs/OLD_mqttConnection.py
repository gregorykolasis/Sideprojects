...
global client,logger,reconnectFlag
client = 'Unknown'
logger = None
reconnectFlag = False
...
def on_connect(client, userdata, flags, rc):
    ...
    if rc==0:
       ...
       if reconnectFlag:
           reconnectFlag=False
           printError("[MQTT]Client reconnected")
    else:
       printGeneral(f"[MQTT]Client bad connection Returned code: {rc}")
