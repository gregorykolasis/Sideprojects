...
class mySerial(asyncio.Protocol):
    ...
    devices = []
    acceptedPorts = [
        {"type": "description", "value": "CH340"},
        {"type": "tag", "value": "QinHeng Electronics CH340 serial converter"},
        {"type": "tag", "value": "QinHeng Electronics HL-340 USB-Serial adapter"},
        {"type": "description", "value": "Arduino Mega 2560"},
        {"type": "tag", "value": "Arduino SA Mega 2560 R3"},
    ]
    printSearching = True
